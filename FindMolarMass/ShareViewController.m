...
- (IBAction)shareTwitter:(id)sender {
    ...
    if ([SLComposeViewController isAvailableForServiceType:SLServiceTypeTwitter])
    {
        ...
        [tweetSheet setInitialText:@"Using this amazing app to do my Chem homework!"];
...
- (IBAction)shareFacebook:(id)sender {
    ...
    if([SLComposeViewController isAvailableForServiceType:SLServiceTypeFacebook]) //check if Facebook Account is linked
    {
        ...
        [mySLComposerSheet setInitialText:[NSString stringWithFormat:@"Using this amazing app to do my chem homework!"]]; //the message you want to post
...
- (IBAction)shareEmail:(id)sender {
    ...
    [mViewController setSubject:@"Check out this Chemistry app!"];
    [mViewController setMessageBody:@"Using this amazing app to do my chem homework!" isHTML:NO];
